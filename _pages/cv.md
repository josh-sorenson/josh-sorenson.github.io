...
Hybird Space Systems, Huntsville, AL | January 2025 – Present
* Perform hybrid rocket motor calculations to aid in the development of flight systems
* Design and build a rocket motor test stand capable of hot firing 10,000 lbf flight units
* Perform structural calculations to ensure test stand meets load capacity requirements
* Machine GSE and flight hardware using mill, lathe, four-axis CNC machine
* Navigate CUI, EAR, and ITAR regulations in partnership with defense and federal agencies

**Graduate Research Assistant**  
Utah State University Propulsion Research Laboratory, Logan, UT | May 2024 – Present
* Develop a method for using a hybrid rocket as a high-enthalpy gas generator to simulate hypersonic conditions (thesis research project)
* Assemble safe plumbing including valves, regulators, tubing, and sensors for test stands
* Assist in validation and initial hot fires for new motors and equipment
